...
> **Related skill:** to scaffold a solution or an additional host (Api / Subscribe / Relay), invoke the [`coreex-scaffold`](/.github/skills/coreex-scaffold/SKILL.md) skill.
...
app.UseOpenApi();
app.UseSwaggerUi();
app.MapHealthChecks(new HealthCheckOptions { AreDetailedEndpointsEnabled = true } /*, detailedGroupConfigure: g => g.RequireAuthorization() */);
app.Run();
```
