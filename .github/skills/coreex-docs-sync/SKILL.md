...
6. **Flags possible orphans** — compares the skill folder names under `.github/skills/coreex-*/` against the current known L1 skill set (listed in [`coreex-ai-workflows.md`](/.github/coreex-ai-workflows.md)); any extra folder is very likely left over from a prior version and should be reviewed for manual removal, not assumed safe.
