...
namespace CoreEx.Database.SqlServer.Test.Console;
...
public class Program
{
    ...
    public static Task<int> Main(string[] args) => SqlServerMigrationConsole
        .Create<Program>("Data Source=127.0.0.1,1433;Initial Catalog=CoreEx.Test;User id=sa;Password=yourStrong(!)Password;TrustServerCertificate=true")
