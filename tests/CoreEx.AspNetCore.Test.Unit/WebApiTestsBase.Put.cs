...
{
    [Test]
    public void Put_Body_No_Response()
    {
        Test.Type<TWebApi>()
            .Run(async w => await w.PutAsync<Person>(Test.CreateJsonHttpRequest(HttpMethod.Put, "test", Person.GetPerson("xx")), (ro, ct) =>
            {
    ...
    [Test]
    public void Put_Value_No_Response()
    {
        Test.Type<TWebApi>()
            .Run(async w => await w.PutAsync(Test.CreateHttpRequest(HttpMethod.Put), Person.GetPerson("xx"), (ro, ct) =>
            {
                ro.ValueOrDefault.Should().NotBeNull();
                ro.ValueOrDefault.FirstName.Should().Be("John");
                ro.ValueOrDefault.LastName.Should().Be("Doe");
    ...
    [Test]
    public void Put_Body_With_Response()
    {
        var hr = Test.CreateJsonHttpRequest(HttpMethod.Put, "test", Person.GetPerson("xx"));
        Test.Type<TWebApi>()
            .Run(async w => await w.PutAsync<Person, Person2>(hr, (ro, ct) =>
            {
                var p = new Person2();
    ...
    [Test]
    public void Put_Value_With_Response()
    {
        var hr = Test.CreateHttpRequest(HttpMethod.Put);
        Test.Type<TWebApi>()
            .Run(async w => await w.PutAsync<Person, Person2>(hr, Person.GetPerson("xx"), (ro, ct) =>
            {
                var p = new Person2();
                p.LastName = ro.ValueOrDefault!.LastName + "X";
                p.FirstName = ro.ValueOrDefault.FirstName + "Y";
    ...
    [Test]
    public void Put_Body_No_Response_IfMatch()
    {
        ...
        Test.Type<TWebApi>()
            .Run(async w => await w.PutAsync<Person>(hr, (ro, ct) =>
            {
                ro.ValueOrDefault.Should().NotBeNull();
                ro.ValueOrDefault.FirstName.Should().Be("John");
                ro.ValueOrDefault.LastName.Should().Be("Doe");
    ...
    [Test]
    public void Put_Value_No_Response_IfMatch()
    {
        var hr = Test.CreateHttpRequest(HttpMethod.Put);
        hr.Headers.IfMatch = new EntityTagHeaderValue("\"abcdefg\"", true).ToString();

        Test.Type<TWebApi>()
            .Run(async w => await w.PutAsync<Person>(hr, Person.GetPerson("123456"), (ro, ct) =>
            {
                ro.ValueOrDefault.Should().NotBeNull();
                ro.ValueOrDefault.FirstName.Should().Be("John");
                ro.ValueOrDefault.LastName.Should().Be("Doe");
