...
/// registered as an empty-<c>fields</c> stub because depth 8 is no longer <c>&lt; MaxDepth</c>.</remarks>
public class Depth0 { public int Id { get; set; } public Depth1? Next { get; set; } }
