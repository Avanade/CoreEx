...
{
    [TestFixture]
    public class JsonMergePatchExTest
    {
        ...
        {
            var td = new TestData();
            Assert.Throws<ArgumentNullException>(() => { new JsonMergePatchEx().Merge(null!, ref td); });
        }
        ...
        {
            var td = new TestData();
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx().Merge(BinaryData.FromString("<xml/>"), ref td));
        ...
        {
            var td = new TestData();
            Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ }"), ref td), Is.False);
        }
        ...
        {
            int i = 1;
            Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("1"), ref i), Is.False);

            Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("2"), ref i), Is.True);
        ...
        public void Merge_Property_StringValue()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"name\": \"Barry\" }"), ref td), Is.True);
        ...
        public void Merge_Property_StringValue_DifferentNameCasingNotSupported()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { PropertyNameComparer = StringComparer.Ordinal }).Merge(BinaryData.FromString("{ \"nAmE\": \"Barry\" }"), ref td), Is.False);
        ...
        public void Merge_Property_StringNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"name\": null }"), ref td), Is.True);
        ...
        {
            var td = new TestData { Name = "Fred" };
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"name\": 123 }"), ref td));
        ...
        {
            var td = new TestData();
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"name\": [ \"Barry\" ] }"), ref td));
        ...
        public void Merge_PrimitiveTypesA()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"id\": \"13512759-4f50-e911-b35c-bc83850db74d\", \"name\": \"Barry\", \"isValid\": true, \"date\": \"2018-12-31\", \"count\": \"12\", \"amount\": 132.58 }"), ref td), Is.True);
        ...
        public void Merge_Property_SubEntityNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"sub\": null }"), ref td), Is.True);
        ...
        public void Merge_Property_SubEntityNewEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"sub\": { } }"), ref td), Is.True);
        ...
        public void Merge_Property_SubEntityExistingEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge<TestData>(BinaryData.FromString("{ \"sub\": { } }"), ref td), Is.False);
                Assert.That(td!.Sub, Is.Not.Null);
                Assert.That(td.Sub!.Code, Is.Null);
                Assert.That(td.Sub.Text, Is.Null);
            });
        ...
        public void Merge_Property_SubEntityExistingChanged()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"sub\": { \"code\": \"x\", \"text\": \"xxx\" } }"), ref td), Is.True);
                Assert.That(td!.Sub, Is.Not.Null);
        ...
        {
            var td = new TestData();
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"values\": { } }"), ref td));
        ...
        public void Merge_Property_ArrayNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"values\": null }"), ref td), Is.True);
        ...
        public void Merge_Property_ArrayEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"values\": [] }"), ref td), Is.True);
        ...
        public void Merge_Property_ArrayValues_NoChanges()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"values\": [ 1, 2, 3] }"), ref td), Is.False);
                Assert.That(td!.Values, Is.Not.Null);
        ...
        public void Merge_Property_ArrayValues_Changes()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"values\": [ 3, 2, 1] }"), ref td), Is.True);
                Assert.That(td!.Values, Is.Not.Null);
                Assert.That(td.Values!, Has.Length.EqualTo(3));
            });
        ...
        public void Merge_Property_NoKeys_ListNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"nokeys\": null }"), ref td), Is.True);
                Assert.That(td!.Values, Is.Null);
            });
        }
        ...
        public void Merge_Property_NoKeys_ListEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"nokeys\": [ ] }"), ref td), Is.True);
        ...
        public void Merge_Property_NoKeys_List()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"nokeys\": [ { \"code\": \"abc\", \"text\": \"xyz\" }, { }, null ] }"), ref td), Is.True);
                Assert.That(td!.NoKeys, Is.Not.Null);
        ...
        public void Merge_Property_Keys_ListNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"keys\": null }"), ref td), Is.True);
        ...
        public void Merge_Property_Keys_ListEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"keys\": [ ] }"), ref td), Is.True);
        ...
        public void Merge_Property_Keys_Replace()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"keys\": [ { \"code\": \"abc\" }, { \"code\": \"uvw\", \"text\": \"xyz\" } ] }"), ref td), Is.True);
        ...
        public void Merge_Property_Keys_NoChanges()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{ \"keys\": [ { \"code\": \"abc\", \"text\": \"def\" } ] }"), ref td), Is.True);
        ...
        public void Merge_Property_KeysColl_ListNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": null }"), ref td), Is.True);
                Assert.That(td!.Values, Is.Null);
            });
        }
        ...
        public void Merge_Property_KeysColl_ListEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ ] }"), ref td), Is.True);
        ...
        {
            var td = new TestData { KeysColl = new KeyDataCollection { new KeyData() } };
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ null, null ] }"), ref td));
        ...
        {
            var td = new TestData { KeysColl = new KeyDataCollection { new KeyData() } };
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { }, { } ] }"), ref td));
            Assert.That(ex!.Message, Is.EqualTo("The JSON array must not contain items with duplicate 'IEntityKey' keys. Path: $.keyscoll"));
        }
        ...
        {
            var td = new TestData { KeysColl = new KeyDataCollection { new KeyData() } };
            var ex = Assert.Throws<JsonMergePatchException>(() => new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { \"code\": \"a\" }, { \"code\": \"a\" } ] }"), ref td));
            Assert.That(ex!.Message, Is.EqualTo("The JSON array must not contain items with duplicate 'IEntityKey' keys. Path: $.keyscoll"));
        }
        ...
        public void Merge_Property_KeysColl_Null_NoChanges()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": null }"), ref td), Is.False);
        ...
        public void Merge_Property_KeysColl_Empty_NoChanges()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ ] }"), ref td), Is.False);
        ...
        public void Merge_Property_KeysColl_Item_NoChanges()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { \"code\": \"a\"  } ] }"), ref td), Is.False);
        ...
        public void Merge_Property_KeysColl_KeyedItem_Changes()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { \"code\": \"a\", \"text\": \"zz\" }, { \"code\": \"b\" } ] }"), ref td), Is.True);
        ...
        public void Merge_Property_KeysColl_KeyedItem_SequenceChanges()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { \"code\": \"b\", \"text\": \"yy\" }, { \"code\": \"a\" } ] }"), ref td), Is.True);
        ...
        public void Merge_Property_KeysColl_KeyedItem_AllNew()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { \"code\": \"y\", \"text\": \"yy\" }, { \"code\": \"z\", \"text\": \"zz\" } ] }"), ref td), Is.True);
        ...
        public void Merge_Property_KeysColl_KeyedItem_Delete()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"keyscoll\": [ { \"code\": \"a\" }, { \"code\": \"c\" } ] }"), ref td), Is.True);
        ...
        public void Merge_Property_DictReplace_Null()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{ \"dict\": null }"), ref td), Is.True);
        ...
        public void Merge_Property_DictReplace_Empty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{ \"dict\": {} }"), ref td), Is.True);
        ...
        public void Merge_Property_DictReplace_NullValue()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{ \"dict\": {\"k\":null} }"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
        ...
        public void Merge_Property_DictReplace_DuplicateKeys_IntoNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict\":{\"k\":\"v\",\"k\":\"v2\"}}"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(1));
        ...
        public void Merge_Property_DictReplace_NoChange()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict\":{\"k\":\"v\",\"k1\":\"v1\"}}"), ref td), Is.False);
                Assert.That(td!.Dict, Is.Not.Null);
        ...
        public void Merge_Property_DictReplace_ReOrder_NoChange()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict\":{\"k1\":\"v1\",\"k\":\"v\"}}"), ref td), Is.False);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_DictReplace_AddUpdateDelete_Replace()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict\":{\"k\":\"v\",\"k2\":\"v2\"}}"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_DictMerge_Null()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"dict\": null }"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Null);
            });
        }
        ...
        public void Merge_Property_DictMerge_Empty()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"dict\": {} }"), ref td), Is.False);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(1));
                Assert.That(td.Dict!["k"], Is.EqualTo("v"));
            });
        ...
        public void Merge_Property_DictMerge_NullValue()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{ \"dict\": {\"k\":null} }"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Is.Empty);
            });
        }
        ...
        public void Merge_Property_DictMerge_DuplicateKeys_IntoNull()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict\":{\"k\":\"v\",\"k\":\"v2\"}}"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(1));
                Assert.That(td.Dict!["k"], Is.EqualTo("v2"));
            });
        ...
        public void Merge_Property_DictMerge_NoChange()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict\":{\"k\":\"v\",\"k1\":\"v1\"}}"), ref td), Is.False);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_DictMerge_ReOrder_NoChange()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict\":{\"k1\":\"v1\",\"k\":\"v\"}}"), ref td), Is.False);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_DictMerge_AddUpdateDelete()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{\"dict\":{\"k\":\"vx\",\"k2\":\"v2\",\"k1\":null}}"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
                Assert.That(td.Dict!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_DictMerge_AddUpdate()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx().Merge(BinaryData.FromString("{\"dict\":{\"k\":\"vx\",\"k2\":\"v2\"}}"), ref td), Is.True);
                Assert.That(td!.Dict, Is.Not.Null);
        ...
        public void Merge_Property_Dict2Replace_DuplicateKeys_IntoEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aa\",\"text\": \"aaa\"},\"a\":{\"code\": \"bb\",\"text\": \"bbb\"}}}"), ref td), Is.True);
        ...
        public void Merge_Property_Dict2Replace_NoChange()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aa\",\"text\": \"aaa\"},\"b\":{\"code\": \"bb\",\"text\": \"bbb\"}}}"), ref td), Is.True);
                Assert.That(td!.Dict2, Is.Not.Null);
        ...
        public void Merge_Property_Dict2Replace_AddUpdateDelete_Replace()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aaaa\"},\"c\":{\"code\": \"cc\",\"text\": \"ccc\"}}}"), ref td), Is.True);
                Assert.That(td!.Dict2, Is.Not.Null);
                Assert.That(td.Dict2!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_KeyDict2Merge_DuplicateKeys_IntoEmpty()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aa\",\"text\": \"aaa\"},\"a\":{\"code\": \"bb\",\"text\": \"bbb\"}}}"), ref td), Is.True);
                Assert.That(td!.Dict2, Is.Not.Null);
                Assert.That(td.Dict2!, Has.Count.EqualTo(1));
            });
        ...
        public void Merge_Property_KeyDict2Merge_NoChange()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aa\",\"text\": \"aaa\"},\"b\":{\"code\": \"bb\",\"text\": \"bbb\"}}}"), ref td), Is.False);
                Assert.That(td!.Dict2, Is.Not.Null);
                Assert.That(td.Dict2!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_KeyDict2Merge_AddUpdateDelete()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aaaa\"},\"c\":{\"code\": \"cc\",\"text\": \"ccc\"},\"b\":null}}"), ref td), Is.True);
                Assert.That(td!.Dict2, Is.Not.Null);
                Assert.That(td.Dict2!, Has.Count.EqualTo(2));
            });
        ...
        public void Merge_Property_KeyDict2Merge_AddUpdate()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString("{\"dict2\":{\"a\":{\"code\": \"aaaa\"},\"c\":{\"code\": \"cc\",\"text\": \"ccc\"}}}"), ref td), Is.True);
                Assert.That(td!.Dict2, Is.Not.Null);
        ...
        [Test]
        public void Merge_XLoadTest_NoCache_1_1000()
        {
            for (int i = 0; i < 1000; i++)
            {
                var td = JsonMergePatchTest._testData;
                new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge, DictionaryMergeApproach = DictionaryMergeApproach.Merge }).Merge(BinaryData.FromString(JsonMergePatchTest._text), ref td);
            }
        }

        [Test]
        public void Merge_XLoadTest_WithCache_1_1000()
        {
            var jmp = new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge, DictionaryMergeApproach = DictionaryMergeApproach.Merge });
            for (int i = 0; i < 1000; i++)
            {
                var td = JsonMergePatchTest._testData;
                jmp.Merge(BinaryData.FromString(JsonMergePatchTest._text), ref td);
            }
        }

        [Test]
        public void Merge_XLoadTest_NoCache_2_1000()
        {
            for (int i = 0; i < 1000; i++)
            {
                var td = JsonMergePatchTest._testData;
        ...
        [Test]
        public void Merge_XLoadTest_WithCache_2_1000()
        {
            var jmp = new JsonMergePatchEx(new JsonMergePatchExOptions { EntityKeyCollectionMergeApproach = EntityKeyCollectionMergeApproach.Merge, DictionaryMergeApproach = DictionaryMergeApproach.Merge });
            for (int i = 0; i < 1000; i++)
            {
        ...
        public void Merge_RootDictionary_Simple()
        {
            ...
            var jmp = new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Merge });
            ...
            jmp = new JsonMergePatchEx(new JsonMergePatchExOptions { DictionaryMergeApproach = DictionaryMergeApproach.Replace });
