...
namespace CoreEx.Test.Framework.Validation.Rules
{
    ...
    public class BetweenRuleTest
    {
        ...
        {
            var v1 = await 1.Validate().Between(1, 10).ValidateAsync();
            Assert.IsFalse(v1.HasErrors);

            v1 = await 5.Validate().Between(1, 10).ValidateAsync();
            Assert.IsFalse(v1.HasErrors);

            v1 = await 1.Validate().Between(2, 10).ValidateAsync();
            ...
            v1 = await 11.Validate().Between(1, 10, "One", "Ten").ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
            ...
            v1 = await 5.Validate().Between(1, 10, exclusiveBetween: true).ValidateAsync();
            Assert.IsFalse(v1.HasErrors);

            v1 = await 1.Validate().Between(1, 10, exclusiveBetween: true).ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
            ...
            v1 = await 10.Validate().Between(1, 10, "One", "Ten", exclusiveBetween: true).ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
        ...
        {
            int? v = null;
            var v1 = await v.Validate().Between(1, 10).ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
            ...
            v = 1;
            v1 = await v.Validate().Between(2, 10).ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
            Assert.AreEqual("Value must be between 2 and 10.", v1.Messages[0].Text);
            Assert.AreEqual(MessageType.Error, v1.Messages[0].Type);
            ...
            v = 11;
            v1 = await v.Validate().Between(1, 10, "One", "Ten").ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
            Assert.AreEqual("Value must be between One and Ten.", v1.Messages[0].Text);
            Assert.AreEqual(MessageType.Error, v1.Messages[0].Type);
            ...
            v = 10;
            v1 = await v.Validate().Between(1, 10, "One", "Ten", exclusiveBetween: true).ValidateAsync();
            Assert.IsTrue(v1.HasErrors);
            Assert.AreEqual(1, v1.Messages!.Count);
            Assert.AreEqual("Value must be between One and Ten (exclusive).", v1.Messages[0].Text);
            Assert.AreEqual(MessageType.Error, v1.Messages[0].Type);
