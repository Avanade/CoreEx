...
namespace CoreEx.Test.Framework.Results
{
    ...
    {
        [Test]
        public void Sync_Result_Then_With_Action_Sucess()
        {
            var i = 0;
        ...
        {
            var r = Result.Success();
            var r2 = r.Then(() => Result.Failure("Test"));
        ...
        {
            var r = Result<int>.Success();
            var r2 = r.Then(() => Result<int>.Failure("Test"));
            Assert.IsTrue(r2.IsFailure);
        }
        ...
        {
            var r = Result<int>.Failure(new BusinessException());
            var r2 = r.Then(() => Result<int>.Failure(new NotFoundException()));
            Assert.IsTrue(r2.IsFailure);
            Assert.That(r2.Error, Is.Not.Null.And.InstanceOf<BusinessException>());
        }
        ...
        [Test]
        public async Task AsyncResult_Result_Then_With_Action_Sucess()
        {
            var i = 0;
        ...
        {
            var i = 0;
            var r = Result.BeginAsync(() => Task.FromResult(Result.Failure(new BusinessException())));
            var r2 = await r.Then(() => i = 1);
            Assert.AreEqual(0, i);
        }
        ...
        public async Task AsyncResult_Result_Then_With_Func_Success()
        {
            ...
            var r2 = await r.Then(() => Result.Failure("Test"));
            Assert.True(r2.IsFailure);
        }
        ...
        {
            var i = 0;
            var r = Result.BeginAsync(() => Task.FromResult(Result<int>.Success()));
            var r2 = await r.Then(() => { i = 1; });
            Assert.AreEqual(1, i);
        }
        ...
        {
            var i = 0;
            var r = Result.BeginAsync(() => Task.FromResult(Result<int>.Failure(new BusinessException())));
            var r2 = await r.Then(() => { i = 1; });
            Assert.AreEqual(0, i);
        }
        ...
        {
            var r = Result.BeginAsync(() => Task.FromResult(Result<int>.Success()));
            var r2 = await r.Then(() => Result<int>.Failure("Test"));
            Assert.IsTrue(r2.IsFailure);
        }
        ...
        {
            var r = Result.BeginAsync(() => Task.FromResult(Result<int>.Failure(new BusinessException())));
            var r2 = await r.Then(() => Result<int>.Failure(new NotFoundException()));
            Assert.IsTrue(r2.IsFailure);
            Assert.That(r2.Error, Is.Not.Null.And.InstanceOf<BusinessException>());
        }
        ...
        [Test]
        public async Task AsyncFunc_Result_Then_With_Action_Sucess()
        {
            var i = 0;
            var r = Result.Success();
        ...
        {
            var r = Result.Success();
            var r2 = await r.ThenAsync(() => Task.FromResult(Result.Failure("Test")));
            Assert.True(r2.IsFailure);
        }
        ...
        {
            var r = Result<int>.Success();
            var r2 = await r.ThenAsync(() => Task.FromResult(Result<int>.Failure("Test")));
            Assert.IsTrue(r2.IsFailure);
        }
        ...
        {
            var r = Result<int>.Failure(new BusinessException());
            var r2 = await r.ThenAsync(() => Task.FromResult(Result<int>.Failure(new NotFoundException())));
            Assert.IsTrue(r2.IsFailure);
            Assert.That(r2.Error, Is.Not.Null.And.InstanceOf<BusinessException>());
        }
        ...
        [Test]
        public async Task AsyncBoth_Result_Then_With_Action_Sucess()
        {
            var i = 0;
        ...
        {
            var i = 0;
            var r = Task.FromResult(Result.Failure(new BusinessException()));
            var r2 = await r.ThenAsync(() => { i = 1; return Task.CompletedTask; });
            Assert.AreEqual(0, i);
        }
        ...
        {
            var i = 0;
            var r = Task.FromResult(Result<int>.Success());
            var r2 = await r.ThenAsync(() => { i = 1; return Task.CompletedTask; });
            Assert.AreEqual(1, i);
        }
        ...
        {
            var i = 0;
            var r = Task.FromResult(Result<int>.Failure(new BusinessException()));
            var r2 = await r.ThenAsync(() => { i = 1; return Task.CompletedTask; });
            Assert.AreEqual(0, i);
        }
