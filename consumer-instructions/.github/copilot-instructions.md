<!--
  ...
  - In a consumer repository: generated by `dotnet new` as `.github/copilot-instructions.md`
    (coreex-bootstrap) or `.github/instructions/coreex.instructions.md` (coreex-ai). Do not hand-edit
