using CoreEx.Gen.Utility;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using Microsoft.CodeAnalysis.Text;
using System.Text;

namespace CoreEx.Gen;
...
{
    private const string _contractAttributeResourceName = "CoreEx.Gen.Templates.ContractAttribute.cs.hb";
    private const string _contractIgnoreAttributeResourceName = "CoreEx.Gen.Templates.ContractIgnoreAttribute.cs.hb";
    private const string _refDataAttributeResourceName = "CoreEx.Gen.Templates.ReferenceDataAttribute.cs.hb";
    private const string _refDataTAttributeResourceName = "CoreEx.Gen.Templates.ReferenceDataTAttribute.cs.hb";
    private const string _refDataCodeCollectionTAttributeResourceName = "CoreEx.Gen.Templates.ReferenceDataCodeCollectionTAttribute.cs.hb";
    private const string _stringAttributeResourceName = "CoreEx.Gen.Templates.StringAttribute.cs.hb";
    private const string _dateTimeAttributeResourceName = "CoreEx.Gen.Templates.DateTimeAttribute.cs.hb";
    private const string _cleanAttributeResourceName = "CoreEx.Gen.Templates.CleanAttribute.cs.hb";
    private const string _templateResourceName = "CoreEx.Gen.Templates.Contract.cs.hb";
