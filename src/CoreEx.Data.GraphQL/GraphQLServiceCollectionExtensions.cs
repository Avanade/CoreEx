...
public static class GraphQLServiceCollectionExtensions
{
    ...
    /// from the current request's scope (e.g. via <c>IHttpContextAccessor.HttpContext.RequestServices</c>) rather than capturing an instance resolved from the root <paramref name="services"/> provider.</remarks>
