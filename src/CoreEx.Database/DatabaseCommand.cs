...
public abstract partial class DatabaseCommand(IDatabase db, SqlStatement statement) : IDatabaseParameters<DatabaseCommand>
{
    ...
    /// </summary>
    public SqlStatement Statement { get; } = statement.ThrowIfNull().ThrowWhen(statement => statement == SqlStatement.None, "A SQL statement of None is not considered valid for execution.");
