...
namespace CoreEx.Database.Mapping
{
    ...
    /// </summary>
    public interface IDatabaseMapperMappings
    {
        /// <summary>
        /// Gets the <see cref="IPropertyColumnMapper"/> mappings.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="IPropertyColumnMapper.ParameterName"/>.
        /// </summary>
        /// <param name="propertyName">The source property name.</param>
        /// <returns>The <see cref="IPropertyColumnMapper.ParameterName"/> where found.</returns>
        /// <exception cref="ArgumentException">Thrown when the property does not exist.</exception>
        string GetParameterName(string propertyName);
