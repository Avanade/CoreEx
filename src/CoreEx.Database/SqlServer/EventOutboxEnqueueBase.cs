...
namespace CoreEx.Database.SqlServer
{
    ...
    /// </summary>
    /// <remarks>By default the events are first sent/enqueued to the database outbox, then a secondary out-of-process dequeues and sends. This can however introduce unwanted latency depending on the frequency in which the secondary process
