...
/// </summary>
/// <remarks>This allows for the validatity dates to be adjusted, per requrest or on-demand, to validate or invalidate the reference date where a <see cref="IReferenceData.StartsOn"/> and/or
/// <see cref="IReferenceData.EndsOn"/> have been configured. As such, this should be a scoped service from an ASP.NET Core dependency injection (DI) perspective. 
...
public interface IReferenceDataContext
{
    ...
    DateTimeOffset? this[Type type] { get; set; }
