...
namespace CoreEx
{
    ...
    public class NotFoundException : Exception, IExtendedException
    {
        ...
        public NotFoundException(string? message) : base(message ?? _message) { }
        ...
        public NotFoundException(string? message, Exception innerException) : base(message ?? _message, innerException) { }

        /// <summary>
        /// <inheritdoc/>
        /// </summary>
        /// <returns>The <see cref="ErrorType.NotFoundError"/> value.</returns>
