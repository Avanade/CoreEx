...
public class WildcardResult
{
    ...
    /// <summary>
    /// Indicates whether the <see cref="Text"/> contains one or more non-<see cref="Wildcard.SupportedSelection"/> errors.
    /// </summary>
    ...
    /// <summary>
    /// Throws an <see cref="InvalidOperationException"/> where result <see cref="HasError"/> is <see langword="true"/>.
    /// </summary>
    ...
    /// <exception cref="InvalidOperationException">Throws an <see cref="InvalidOperationException"/> where result <see cref="HasError"/> is <see langword="true"/>.</exception>
