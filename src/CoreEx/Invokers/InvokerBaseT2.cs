...
namespace CoreEx.Invokers
{
    ...
    /// <remarks>All public methods result in either the synchronous <see cref="OnInvoke{TResult}(TInvoker, Func{TResult}, TArgs?)"/> or asynchronous <see cref="OnInvokeAsync{TResult}(TInvoker, Func{CancellationToken, Task{TResult}}, TArgs?, CancellationToken)"/>
    ...
    public abstract class InvokerBase<TInvoker, TArgs>
    {
        ...
        protected virtual TResult OnInvoke<TResult>(TInvoker invoker, Func<TResult> func, TArgs? args) => func();
        ...
        /// <returns>The result.</returns>
        protected virtual Task<TResult> OnInvokeAsync<TResult>(TInvoker invoker, Func<CancellationToken, Task<TResult>> func, TArgs? args, CancellationToken cancellationToken) => func(cancellationToken);
        ...
        public void Invoke(TInvoker invoker, Action action, TArgs? args = default)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(); return null!; }, args);
        ...
        public void Invoke<T1>(TInvoker invoker, T1 p1, Action<T1> action, TArgs? args = default)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1); return null!; }, args);
        ...
        public void Invoke<T1, T2>(TInvoker invoker, T1 p1, T2 p2, Action<T1, T2> action, TArgs? args = default)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1, p2); return null!; }, args);
        ...
        public void Invoke<T1, T2, T3>(TInvoker invoker, T1 p1, T2 p2, T3 p3, Action<T1, T2, T3> action, TArgs? args = default)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1, p2, p3); return null!; }, args);
        ...
        public void Invoke<T1, T2, T3, T4>(TInvoker invoker, T1 p1, T2 p2, T3 p3, T4 p4, Action<T1, T2, T3, T4> action, TArgs? args = default)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1, p2, p3, p4); return null!; }, args);
        ...
        public TResult Invoke<TResult>(TInvoker invoker, Func<TResult> func, TArgs? args = default)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(), args);
        ...
        public TResult Invoke<T1, TResult>(TInvoker invoker, T1 p1, Func<T1, TResult> func, TArgs? args = default)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1), args);
        ...
        public TResult Invoke<T1, T2, TResult>(TInvoker invoker, T1 p1, T2 p2, Func<T1, T2, TResult> func, TArgs? args = default)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1, p2), args);
        ...
        public TResult Invoke<T1, T2, T3, TResult>(TInvoker invoker, T1 p1, T2 p2, T3 p3, Func<T1, T2, T3, TResult> func, TArgs? args = default)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1, p2, p3), args);
        ...
        public TResult Invoke<T1, T2, T3, T4, TResult>(TInvoker invoker, T1 p1, T2 p2, T3 p3, T4 p4, Func<T1, T2, T3, T4, TResult> func, TArgs? args = default)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1, p2, p3, p4), args);
