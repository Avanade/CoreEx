...
namespace CoreEx.Invokers
{
    ...
    /// <remarks>All public methods result in either the synchronous <see cref="OnInvoke{TResult}(TInvoker, Func{TResult})"/> or asynchronous <see cref="OnInvokeAsync{TResult}(TInvoker, Func{CancellationToken, Task{TResult}}, CancellationToken)"/>
    ...
    public abstract class InvokerBase<TInvoker>
    {
        ...
        protected virtual TResult OnInvoke<TResult>(TInvoker invoker, Func<TResult> func) => func();
        ...
        /// <returns>The result.</returns>
        protected virtual Task<TResult> OnInvokeAsync<TResult>(TInvoker invoker, Func<CancellationToken, Task<TResult>> func, CancellationToken cancellationToken) => func(cancellationToken);
        ...
        public void Invoke(TInvoker invoker, Action action)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(); return null!; });
        ...
        public void Invoke<T1>(TInvoker invoker, T1 p1, Action<T1> action)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1); return null!; });
        ...
        public void Invoke<T1, T2>(TInvoker invoker, T1 p1, T2 p2, Action<T1, T2> action)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1, p2); return null!; });
        ...
        public void Invoke<T1, T2, T3>(TInvoker invoker, T1 p1, T2 p2, T3 p3, Action<T1, T2, T3> action)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1, p2, p3); return null!; });
        ...
        public void Invoke<T1, T2, T3, T4>(TInvoker invoker, T1 p1, T2 p2, T3 p3, T4 p4, Action<T1, T2, T3, T4> action)
            => OnInvoke<object?>(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => { (action ?? throw new ArgumentNullException(nameof(action))).Invoke(p1, p2, p3, p4); return null!; });
        ...
        public TResult Invoke<TResult>(TInvoker invoker, Func<TResult> func)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func());
        ...
        public TResult Invoke<T1, TResult>(TInvoker invoker, T1 p1, Func<T1, TResult> func)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1));
        ...
        public TResult Invoke<T1, T2, TResult>(TInvoker invoker, T1 p1, T2 p2, Func<T1, T2, TResult> func)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1, p2));
        ...
        public TResult Invoke<T1, T2, T3, TResult>(TInvoker invoker, T1 p1, T2 p2, T3 p3, Func<T1, T2, T3, TResult> func)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1, p2, p3));
        ...
        public TResult Invoke<T1, T2, T3, T4, TResult>(TInvoker invoker, T1 p1, T2 p2, T3 p3, T4 p4, Func<T1, T2, T3, T4, TResult> func)
            => OnInvoke(invoker ?? throw new ArgumentNullException(nameof(invoker)), () => func(p1, p2, p3, p4));
