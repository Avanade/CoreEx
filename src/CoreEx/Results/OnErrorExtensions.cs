...
namespace CoreEx.Results
{
    ...
    public static class OnErrorExtensions
    {
        ...
        /// <param name="func">The <see cref="Func{TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static Result<U> OnError<T, U>(this Result result, Func<Result<U>> func)
            => result.IsFailure ? (func ?? throw new ArgumentNullException(nameof(func))).Invoke() : result.Combine(Result<U>.Successful);
        ...
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static Result<U> OnError<T, U>(this Result<T> result, Func<T, Result<U>> func)
            => result.IsFailure ? (func ?? throw new ArgumentNullException(nameof(func))).Invoke(result.Value) : result.Combine(Result<U>.Successful);
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static Result<U> OnError<T, U>(this Result<T> result, Func<T, U> func)
            => result.IsFailure ? (func ?? throw new ArgumentNullException(nameof(func))).Invoke(result.Value) : result.Combine(Result<U>.Successful);
        ...
        /// <param name="func">The <see cref="Func{TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnError<T, U>(this Task<Result> result, Func<Result<U>> func)
        {
            var r = await result.ConfigureAwait(false);
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnError<T, U>(this Task<Result<T>> result, Func<T, Result<U>> func)
        {
            var r = await result.ConfigureAwait(false);
            return r.OnError(func);
        }
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnError<T, U>(this Task<Result<T>> result, Func<T, U> func)
        {
            var r = await result.ConfigureAwait(false);
            return r.OnError(func);
        }
        ...
        /// <param name="func">The <see cref="Func{TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnErrorAsync<T, U>(this Result result, Func<Task<Result<U>>> func)
        {
            if (func == null) throw new ArgumentNullException(nameof(func));
            return result.IsFailure ? await func().ConfigureAwait(false) : result.Combine(Result<U>.Successful);
        }
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnErrorAsync<T, U>(this Result<T> result, Func<T, Task<Result<U>>> func)
        {
            if (func == null) throw new ArgumentNullException(nameof(func));
            return result.IsFailure ? await func(result.Value).ConfigureAwait(false) : result.Combine(Result<U>.Successful);
        }
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnErrorAsync<T, U>(this Result<T> result, Func<T, Task<U>> func)
        {
            if (func == null) throw new ArgumentNullException(nameof(func));
            return result.IsFailure ? await func(result.Value).ConfigureAwait(false) : result.Combine(Result<U>.Successful);
        }
        ...
        /// <param name="func">The <see cref="Func{TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnErrorAsync<T, U>(this Task<Result> result, Func<Task<Result<U>>> func)
        {
            if (func == null) throw new ArgumentNullException(nameof(func));
            var r = await result.ConfigureAwait(false);
            return await r.OnErrorAsync(func).ConfigureAwait(false);
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnErrorAsync<T, U>(this Task<Result<T>> result, Func<T, Task<Result<U>>> func)
        {
            if (func == null) throw new ArgumentNullException(nameof(func));
            var r = await result.ConfigureAwait(false);
            return await r.OnErrorAsync(func).ConfigureAwait(false);
        ...
        /// <param name="func">The <see cref="Func{T, TResult}"/> to invoke.</param>
        /// <returns>The resulting <see cref="Result{T}"/>.</returns>
        public static async Task<Result<U>> OnErrorAsync<T, U>(this Task<Result<T>> result, Func<T, Task<U>> func)
        {
            if (func == null) throw new ArgumentNullException(nameof(func));
            var r = await result.ConfigureAwait(false);
            return await r.OnErrorAsync(func).ConfigureAwait(false);
