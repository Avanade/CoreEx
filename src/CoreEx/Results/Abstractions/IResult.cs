...
public interface IResult
{
    ...
    /// </summary>
    /// <remarks>Where <see langword="true"/> then the <see cref="Error"/> will contain a corresponding <see cref="Exception"/>.</remarks>
    bool IsFailure { get; }
    ...
    /// <returns><see langword="true"/> indicates that the result is in a failure state <i>and</i> the underlying error is of the specified <typeparamref name="TException"/> <see cref="Type"/>.</returns>
