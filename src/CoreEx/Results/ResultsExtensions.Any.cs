...
public static partial class ResultsExtensions
{
    ...
    {
        ThrowIfNull(result, func);
        return Result<T>.Ok(func(result.ValueOrDefault));
    }
    ...
    {
        ThrowIfNull(result, func);
        return func(result.ValueOrDefault);
    }
    ...
    {
        ThrowIfNull(result, func);
        return Result<U>.Ok(func(result.ValueOrDefault));
    }
    ...
    {
        ThrowIfNull(result, func);
        await func(result.ValueOrDefault).ConfigureAwait(false);
        return result;
    }
    ...
    {
        ThrowIfNull(result, func);
        return Result<T>.Ok(await func(result.ValueOrDefault).ConfigureAwait(false));
    }
    ...
    {
        ThrowIfNull(result, func);
        return await func(result.ValueOrDefault).ConfigureAwait(false);
    }
    ...
    {
        ThrowIfNull(result, func);
        return Result<U>.Ok(await func(result.ValueOrDefault).ConfigureAwait(false));
    }
