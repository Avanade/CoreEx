...
public static partial class ResultsExtensions
{
    ...
    /// <summary>
    /// Executes the <paramref name="action"/> where the <paramref name="result"/> is <see cref="Result.IsSuccess"/> and <paramref name="condition"/> evaluates to <see langword="true"/>.
    /// </summary>
    /// <param name="result">The <see cref="Result"/>.</param>
    /// <param name="condition">The condition/predicate that must also be evaluated.</param>
    /// <param name="action">The function to invoke where <paramref name="condition"/> is <see langword="true"/> (where <paramref name="result"/> is <see cref="Result.IsSuccess"/>).</param>
    /// <param name="otherwise">The function to invoke where <paramref name="condition"/> is <see langword="false"/> (where <paramref name="result"/> is <see cref="Result.IsSuccess"/>).</param>
    ...
    /// <summary>
    /// Executes the <paramref name="func"/> where the <paramref name="result"/> is <see cref="Result.IsSuccess"/> and <paramref name="condition"/> evaluates to <see langword="true"/>.
    /// </summary>
    /// <param name="result">The <see cref="Result"/>.</param>
    /// <param name="condition">The condition/predicate that must also be evaluated.</param>
    /// <param name="func">The function to invoke where <paramref name="condition"/> is <see langword="true"/> (where <paramref name="result"/> is <see cref="Result.IsSuccess"/>).</param>
    /// <param name="otherwise">The function to invoke where <paramref name="condition"/> is <see langword="false"/> (where <paramref name="result"/> is <see cref="Result.IsSuccess"/>).</param>
    /// <returns>The resulting <see cref="Result"/>.</returns>
    ...
    /// <summary>
    /// Executes the <paramref name="func"/> where the <paramref name="result"/> is <see cref="Result.IsSuccess"/>  and <paramref name="condition"/> evaluates to <see langword="true"/> (the <paramref name="result"/> <see cref="Result{T}.Value"/> will not be lost).
    /// </summary>
    /// <typeparam name="T">The <see cref="Result{T}.Value"/> <see cref="Type"/>.</typeparam>
    /// <param name="result">The <see cref="Result{T}"/>.</param>
    /// <param name="condition">The condition/predicate that must also be evaluated.</param>
    ...
    /// <summary>
    /// Executes the <paramref name="func"/> where the <paramref name="result"/> is <see cref="Result.IsSuccess"/> and <paramref name="condition"/> evaluates to <see langword="true"/> (as new <see cref="Result"/> <see cref="Type"/>).
    /// </summary>
    /// <typeparam name="T">The <see cref="Result{T}.Value"/> <see cref="Type"/>.</typeparam>
    /// <param name="result">The <see cref="Result{T}"/>.</param>
    /// <param name="condition">The condition/predicate that must also be evaluated.</param>
    ...
    /// <summary>
    /// Executes the <paramref name="action"/> where the <paramref name="result"/> is <see cref="Result.IsSuccess"/> and <paramref name="condition"/> evaluates to <see langword="true"/> (as new <see cref="Result"/> <see cref="Type"/>).
    /// </summary>
    /// <typeparam name="T">The <see cref="Result{T}.Value"/> <see cref="Type"/>.</typeparam>
    /// <param name="result">The <see cref="Result{T}"/>.</param>
    /// <param name="condition">The condition/predicate that must also be evaluated.</param>
    ...
    /// <param name="otherwise">The <see cref="Func{T, TResult}"/> to invoke where condition/predicate is <see langword="false"/> (where <paramref name="result"/> is also <see cref="Result.IsSuccess"/>).</param>
    /// <returns>The resulting <see cref="Result{T}"/>.</returns>
