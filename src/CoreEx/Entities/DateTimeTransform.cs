...
namespace CoreEx.Entities
{
    ...
    /// </summary>
    /// <remarks>The option to perform specified <see cref="DateTime"/> transformations ensures that a class is updated with the correctly specified <see cref="DateTime"/> values and <see cref="DateTime.Kind"/>.
    /// This is especially important where serialization is required across the likes of time-zones to ensure that the correct values are passed.</remarks>
    public enum DateTimeTransform
    {
        ...
        /// <summary>
        /// No transform required; the <see cref="DateTime"/> value will be updated as-is.
        /// </summary>
        None,
