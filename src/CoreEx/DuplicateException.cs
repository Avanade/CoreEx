...
namespace CoreEx
{
    ...
    public class DuplicateException : Exception, IExtendedException
    {
        ...
        public DuplicateException(string? message) : base(message ?? _message) { }
        ...
        public DuplicateException(string? message, Exception innerException) : base(message ?? _message, innerException) { }

        /// <summary>
        /// <inheritdoc/>
        /// </summary>
        /// <returns>The <see cref="ErrorType.DuplicateError"/> value.</returns>
