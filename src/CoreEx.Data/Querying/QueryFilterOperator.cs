...
public enum QueryFilterOperator
{
    ...
    /// <summary>
    /// The <see cref="bool"/> <i>equality</i> operators.
    /// </summary>
    BooleanEqualityOperators = Equal | NotEqual,
    ...
    /// <summary>
    /// The <see cref="string"/>-specific function-based operators.
    /// </summary>
    StringFunctions = StartsWith | EndsWith | Contains,

    /// <summary>
    /// All <see cref="string"/>-specific operators and functions.
    /// </summary>
