...
public abstract class QueryFilterExpressionBase
{
    ...
    /// <summary>
    /// Writes the query filter expression into the corresponding dynamic LINQ.
    /// </summary>
    /// <param name="writer">The <see cref="QueryFilterParserWriter"/>.</param>
    public abstract void WriteAsDynamicLinq(QueryFilterParserWriter writer);
}