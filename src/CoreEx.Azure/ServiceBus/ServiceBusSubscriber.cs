...
namespace CoreEx.Azure.ServiceBus
{
    ...
    public class ServiceBusSubscriber : EventSubscriberBase, IServiceBusSubscriber
    {
        ...
        public Task ReceiveAsync(ServiceBusReceivedMessage message, ServiceBusMessageActions messageActions, Func<EventData, Task> function, EventSubscriberArgs? args = null, Func<EventData, Task>? afterReceive = null, CancellationToken cancellationToken = default)
        {
            if (message == null)
        ...
        public Task ReceiveAsync<TValue>(ServiceBusReceivedMessage message, ServiceBusMessageActions messageActions, Func<EventData<TValue>, Task> function, bool valueIsRequired = true, IValidator<TValue>? validator = null,
            EventSubscriberArgs? args = null, Func<EventData<TValue>, Task>? afterReceive = null, CancellationToken cancellationToken = default)
        {
            if (message == null)
                throw new ArgumentNullException(nameof(message));
