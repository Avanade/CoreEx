...
namespace CoreEx.Validation
{
    ...
    public static class ValidatorStrings
    {
        ...
        public static readonly LText BetweenInclusiveFormat = new("CoreEx.Validation.BetweenInclusiveFormat");

        /// <summary>
        /// Gets the format string for the compare equal error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must be between {2} and {3} (exclusive).</i></remarks>
        public static readonly LText BetweenExclusiveFormat = new("CoreEx.Validation.BetweenExclusiveFormat");

        /// <summary>
        /// Gets the format string for the compare equal error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must be equal to {2}.</i></remarks>
        public static readonly LText CompareEqualFormat = new("CoreEx.Validation.CompareEqualFormat");

        /// <summary>
        /// Gets the format string for the compare not equal error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must not be equal to {2}.</i></remarks>
        public static readonly LText CompareNotEqualFormat = new("CoreEx.Validation.CompareNotEqualFormat");

        /// <summary>
        /// Gets the format string for the compare less than error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must be less than {2}.</i></remarks>
        public static readonly LText CompareLessThanFormat = new("CoreEx.Validation.CompareLessThanFormat");
        ...
        public static readonly LText CompareLessThanEqualFormat = new("CoreEx.Validation.CompareLessThanEqualFormat");
        ...
        public static readonly LText CompareGreaterThanFormat = new("CoreEx.Validation.CompareGreaterThanFormat");
        ...
        public static readonly LText CompareGreaterThanEqualFormat = new("CoreEx.Validation.CompareGreaterThanEqualFormat");
        ...
        public static readonly LText MaxDigitsFormat = new("CoreEx.Validation.MaxDigitsFormat");
        ...
        public static readonly LText DecimalPlacesFormat = new("CoreEx.Validation.DecimalPlacesFormat");

        /// <summary>
        /// Gets the format string for the duplicate error message.
        /// </summary>
        /// <remarks>Defaults to: <i>xxx</i></remarks>
        public static readonly LText DuplicateFormat = new("CoreEx.Validation.DuplicateFormat");
        ...
        public static readonly LText DuplicateValueFormat = new("CoreEx.Validation.DuplicateValueFormat");
        ...
        public static readonly LText DuplicateValue2Format = new("CoreEx.Validation.DuplicateValue2Format");

        /// <summary>
        /// Gets the format string for the minimum count error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must have at least {2} item(s).</i></remarks>
        public static readonly LText MinCountFormat = new("CoreEx.Validation.MinCountFormat");

        /// <summary>
        /// Gets the format string for the maximum count error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must not exceed {2} item(s).</i></remarks>
        public static readonly LText MaxCountFormat = new("CoreEx.Validation.MaxCountFormat");
        ...
        public static readonly LText ExistsFormat = new("CoreEx.Validation.ExistsFormat");
        ...
        public static readonly LText ImmutableFormat = new("CoreEx.Validation.ImmutableFormat");

        /// <summary>
        /// Gets the format string for the Mandatory error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} is required.</i></remarks>
        public static readonly LText MandatoryFormat = new("CoreEx.Validation.MandatoryFormat");

        /// <summary>
        /// Gets the format string for the must error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} is invalid.</i></remarks>
        public static readonly LText MustFormat = new("CoreEx.Validation.MustFormat");

        /// <summary>
        /// Gets the format string for the allow negatives error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} must not be negative.</i></remarks>
        public static readonly LText AllowNegativesFormat = new("CoreEx.Validation.AllowNegativesFormat");

        /// <summary>
        /// Gets the format string for the invalid error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} is invalid.</i></remarks>
        public static readonly LText InvalidFormat = new("CoreEx.Validation.InvalidFormat");
        ...
        public static readonly LText MinLengthFormat = new("CoreEx.Validation.MinLengthFormat");
        ...
        public static readonly LText MaxLengthFormat = new("CoreEx.Validation.MaxLengthFormat");

        /// <summary>
        /// Gets the format string for the regex error message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} is invalid.</i></remarks>
        public static readonly LText RegexFormat = new("CoreEx.Validation.RegexFormat");
        ...
        public static readonly LText WildcardFormat = new("CoreEx.Validation.WildcardFormat");
        ...
        public static readonly LText CollectionNullItemFormat = new("CoreEx.Validation.CollectionNullItemFormat");
        ...
        public static readonly LText DictionaryNullKeyFormat = new("CoreEx.Validation.DictionaryNullKeyFormat");
        ...
        public static readonly LText DictionaryNullValueFormat = new("CoreEx.Validation.DictionaryNullValueFormat");

        /// <summary>
        /// Gets the format string for the invalid email message.
        /// </summary>
        /// <remarks>Defaults to: <i>{0} is an invalid e-mail address.</i></remarks>
        public static readonly LText EmailFormat = new("CoreEx.Validation.EmailFormat");

        /// <summary>
        /// Gets the string for the <see cref="Entities.IPrimaryKey.PrimaryKey"/> literal.
        /// </summary>
        /// <remarks>Defaults to: <i>Primary Key</i></remarks>
        public static readonly LText PrimaryKey = new("CoreEx.Validation.PrimaryKey");
    }
}