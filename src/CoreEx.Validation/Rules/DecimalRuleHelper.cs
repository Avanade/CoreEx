...
namespace CoreEx.Validation.Rules
{
    ...
    public static class DecimalRuleHelper
    {
        ...
        /// </summary>
        internal static bool CheckMaxDigits(int maxDigits, int? decimalPlaces, int il, int dp) => (il + (decimalPlaces ?? dp)) <= maxDigits;
        ...
        /// </summary>
        internal static bool CheckDecimalPlaces(int decimalPlaces, int dp) => dp <= decimalPlaces;
