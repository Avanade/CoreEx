...
{
    /// <summary>
    /// Provides <see cref="Nullable{T}"/> <see cref="Enum"/> validation to ensure that the value has been defined.
    /// </summary>
    /// <typeparam name="TEntity">The entity <see cref="System.Type"/>.</typeparam>
    /// <typeparam name="TProperty">The property <see cref="Type"/>.</typeparam>
    public class NullableEnumRule<TEntity, TProperty> : ValueRuleBase<TEntity, TProperty?> where TEntity : class where TProperty : struct, Enum
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnumRule{TEntity, TProperty}"/> class.
        /// </summary>
        public NullableEnumRule() => ValidateWhenDefault = false;
        ...
        protected override Task ValidateAsync(PropertyContext<TEntity, TProperty?> context, CancellationToken cancellationToken = default)
        {
            ...
            if (context.Value is null || !Enum.IsDefined(typeof(TProperty), context.Value))
