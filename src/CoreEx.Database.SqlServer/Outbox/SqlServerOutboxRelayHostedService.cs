...
/// <summary>
/// Provides the <see href="https://learn.microsoft.com/en-us/sql/">SQL Server</see> <see cref="IDatabaseOutboxRelay.RelayAsync"/> execution leveraging a <see cref="TimerHostedServiceBase"/>.
/// </summary>
