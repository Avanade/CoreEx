...
{
    /// <summary>
    /// Adds the named parameter and value, using the specified <see cref="SqlDbType"/> and <see cref="ParameterDirection"/>, to the <see cref="DbCommand.Parameters"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds the named parameter and value, using the specified <see cref="SqlDbType"/> and <see cref="ParameterDirection"/>.
    /// </summary>
    /// <param name="parameters">The <see cref="DatabaseParameterCollection"/>.</param>
    /// <param name="name">The parameter name.</param>
    /// <param name="value">The parameter value.</param>
    ...
    /// <param name="direction">The <see cref="ParameterDirection"/> (default to <see cref="ParameterDirection.Input"/>).</param>
    /// <returns></returns>
    public static TSelf Param<TSelf, T>(this IDatabaseParameters<TSelf> parameters, string name, T? value, SqlDbType? sqlDbType = null, ParameterDirection direction = ParameterDirection.Input)
    {
        parameters.ThrowIfNull().Parameters.AddParameter(name, value, sqlDbType, direction);
