...
namespace CoreEx.Cosmos
{
    ...
    public class CosmosDbContainerBase<TSelf>(ICosmosDb cosmosDb, string containerId, CosmosDbArgs? dbArgs = null) : ICosmosDbContainer where TSelf : CosmosDbContainerBase<TSelf>
    {
