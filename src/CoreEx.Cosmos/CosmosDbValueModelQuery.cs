...
namespace CoreEx.Cosmos
{
    ...
    public class CosmosDbValueModelQuery<TModel> : CosmosDbModelQueryBase<CosmosDbValue<TModel>, CosmosDbValueModelQuery<TModel>> where TModel : class, IIdentifier, new()
    {
        ...
        public CosmosDbValueModelQuery(ICosmosDbContainer container, CosmosDbArgs dbArgs, Func<IQueryable<CosmosDbValue<TModel>>, IQueryable<CosmosDbValue<TModel>>>? query) : base(container, dbArgs) => _query = query;
        ...
        private IQueryable<CosmosDbValue<TModel>> AsQueryable(bool allowSynchronousQueryExecution, bool pagingSupported)
        {
            ...
            IQueryable<CosmosDbValue<TModel>> query = Container.Container.GetItemLinqQueryable<CosmosDbValue<TModel>>(allowSynchronousQueryExecution: allowSynchronousQueryExecution, requestOptions: Container.CosmosDb.GetQueryRequestOptions<TModel>(QueryArgs));
