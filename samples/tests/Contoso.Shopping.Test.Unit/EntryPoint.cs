...
public class EntryPoint
{
    public static void ConfigureApplication(IHostApplicationBuilder builder)
    {
        ...
        var jdr = JsonDataReader.ParseYaml<Contoso.Shopping.Database.Program>("ref-data.yaml", JsonDataReaderOptions.CreateForReferenceData(JsonPropertyNamingConvention.SnakeCase));
