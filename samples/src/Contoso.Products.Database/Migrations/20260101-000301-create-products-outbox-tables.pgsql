...
CREATE INDEX "ix_products_outbox_partition_order" ON "products"."outbox" ("tenant_id", "partition_id", "outbox_id", "status", "available_utc", "lease_until_utc", "destination", "attempts");
