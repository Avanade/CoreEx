...
public class CustomerReadController(WebApi webApi, ICustomerReadService service) : ControllerBase
{
    private readonly WebApi _webApi = webApi.ThrowIfNull();
    private readonly ICustomerReadService _service = service.ThrowIfNull();
    ...
    [HttpGet]
    [ProducesResponseType(typeof(CustomerLite[]), 200)]
