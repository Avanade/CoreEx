...
namespace My.Hr.UnitTest
{
    [TestFixture]
    [Category("WithDB")]
    public class EmployeeResultControllerTest
    {
        [OneTimeSetUp]
        public static async Task Init()
        {
            ...
            var args = Database.Program.ConfigureMigrationArgs(new MigrationArgs(MigrationCommand.ResetAndDatabase, cs)).AddAssembly<EmployeeResultControllerTest>();
        ...
        public void A100_Get_NotFound()
        {
            ...
            test.Controller<EmployeeResultController>()
        ...
        public void A120_Get_NotModifed()
        {
            ...
            var e = test.Controller<EmployeeResultController>()
                .Run(c => c.GetAsync(1.ToGuid()))
                .AssertOK()
                .GetValue<Employee>()!;
        ...
        public void D120_Update_Success()
        {
            ...
            v = test.Controller<EmployeeResultController>()
